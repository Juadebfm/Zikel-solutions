...
export function YoungPeopleTab() {
  ...
  const {
    data: allYP = [],
    error: youngPeopleError,
    isLoading: isYoungPeopleLoading,
  } = useYoungPeople()
    ...
    <div className="space-y-6">
      ...
      <div className="border rounded-lg bg-white overflow-x-auto">
        <Table className="min-w-200">
          ...
          <TableBody>
            {isYoungPeopleLoading && allYP.length === 0 ? (
              <TableRow>
                <TableCell
              ...
              <TableRow>
                <TableCell
                  colSpan={visibleColumnDefs.length + 1}
                  className={`text-center py-10 ${youngPeopleErrorMessage ? "text-red-600" : "text-gray-400"}`}
                >
                  {youngPeopleErrorMessage ?? "No Data"}
                </TableCell>
              </TableRow>
            ) : (

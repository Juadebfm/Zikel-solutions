    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Organise homes and staff into logical groupings.
        </p>
      </div>
      ...
      <div className="flex gap-2">
        <Button className="gap-2" onClick={() => guard(() => console.log("Add grouping"))}>
          <Plus className="h-4 w-4" />
          Add Grouping
        </Button>
        <Button variant="outline" className="gap-2" onClick={() => guard(() => console.log("Edit grouping"))}>
          <Pencil className="h-4 w-4" />
          Edit
        </Button>
        <Button variant="outline" className="gap-2 text-red-600 hover:text-red-700" onClick={() => guard(() => console.log("Delete grouping"))}>
        ...
        <CardContent className="py-10">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">
              Grouping configuration and management tools will appear here.
            </p>
          </div>
        </CardContent>
      </Card>

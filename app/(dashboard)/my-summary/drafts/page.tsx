      ...
      <Dialog open={confirmDialog?.type === "submit"} onOpenChange={(v) => !v && setConfirmDialog(null)}>
        <DialogContent className="sm:max-w-md rounded-2xl border-0 bg-white shadow-2xl">
          ...
          <DialogFooter>
            ...
            <MutationButton className="bg-primary hover:bg-primary/90 text-white rounded-lg" disabled={isPending} onClick={() => confirmDialog && handleSubmit(confirmDialog.taskIds)}>

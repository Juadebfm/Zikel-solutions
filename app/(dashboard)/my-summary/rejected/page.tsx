...
export default function RejectedTasksPage() {
  ...
  const colors = statusColors.rejected
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-1.5 text-sm text-gray-500 mb-1">
          ...
          <span className="text-gray-900 font-medium">Rejected Tasks</span>
        </div>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <h1 className="text-2xl font-bold text-gray-900">Rejected Tasks</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            <div className="p-2 rounded-lg bg-orange-100"><XCircle className="h-4 w-4 text-orange-600" /></div>
            <div>
        ...
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            <div className="p-2 rounded-lg bg-red-100"><AlertTriangle className="h-4 w-4 text-red-600" /></div>
            <div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-50">
              ...
              <TableHead className="font-semibold text-gray-700">Rejected At</TableHead>
              ...
              allTasks.map((task, index: number) => {
                ...
                return (
                  <TableRow key={task.id} className={index % 2 === 0 ? "bg-white" : "bg-gray-50/60"}>
                    ...
                    <TableCell>
                      <div className="space-y-0.5">
                        <p className="text-sm text-orange-600 font-medium whitespace-nowrap">{formatRelativeDate(rejectedAt)}</p>
                        <p className="text-xs text-gray-400 whitespace-nowrap">{formatShortDate(rejectedAt)}</p>
                      </div>
                    </TableCell>

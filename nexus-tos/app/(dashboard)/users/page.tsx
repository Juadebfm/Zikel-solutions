  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-2">
        <Button className="gap-2" onClick={() => guard(() => console.log("Add user"))}>
          <Plus className="h-4 w-4" />
          Add User
        </Button>
        <Button variant="outline" className="gap-2" onClick={() => guard(() => console.log("Edit user"))}>
          <Pencil className="h-4 w-4" />
          Edit
        </Button>
        <Button variant="outline" className="gap-2 text-red-600 hover:text-red-700" onClick={() => guard(() => console.log("Delete user"))}>
        ...
        <CardContent className="py-10">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">
              User management and role assignment tools will appear here.
            </p>
          </div>
        </CardContent>
      </Card>

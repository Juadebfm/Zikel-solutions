  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-2">
        <Button className="gap-2" onClick={() => guard(() => console.log("Add vehicle"))}>
          <Plus className="h-4 w-4" />
          Add Vehicle
        </Button>
        <Button variant="outline" className="gap-2" onClick={() => guard(() => console.log("Edit vehicle"))}>
          <Pencil className="h-4 w-4" />
          Edit
        </Button>
        <Button variant="outline" className="gap-2 text-red-600 hover:text-red-700" onClick={() => guard(() => console.log("Delete vehicle"))}>
        ...
        <CardContent className="py-10">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">
              Vehicle fleet management tools will appear here.
            </p>
          </div>
        </CardContent>
      </Card>

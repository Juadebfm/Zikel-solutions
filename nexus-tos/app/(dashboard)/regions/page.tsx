    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Configure and manage operational regions.
        </p>
      </div>
      ...
      <div className="flex gap-2">
        <Button className="gap-2" onClick={() => guard(() => console.log("Add region"))}>
          <Plus className="h-4 w-4" />
          Add Region
        </Button>
        <Button variant="outline" className="gap-2" onClick={() => guard(() => console.log("Edit region"))}>
          <Pencil className="h-4 w-4" />
          Edit
        </Button>
        <Button variant="outline" className="gap-2 text-red-600 hover:text-red-700" onClick={() => guard(() => console.log("Delete region"))}>
        ...
        <CardContent className="py-10">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">
              Region configuration and management tools will appear here.
            </p>
          </div>
        </CardContent>
      </Card>

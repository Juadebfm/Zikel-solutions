...
const settingsCategories: { key: string; label: string }[] = [
  ...
  { key: "reference-ratings", label: "Reference Ratings" },
  { key: "qualification-types", label: "Qualification Types" },
  { key: "qualification-issuing-bodies", label: "Qualification Issuing Bodies" },
  { key: "evidence-types", label: "Evidence Types" },
  { key: "contract-types", label: "Contract Types" },
  { key: "contract-events", label: "Contract Events" },
  { key: "file-categories", label: "File Categories" },
  { key: "leave-types", label: "Leave Types" },
  { key: "leave-statuses", label: "Leave Statuses" },
  { key: "genders", label: "Genders" },
  { key: "employment-types", label: "Employment Types" },
  { key: "custom-personal-group", label: "Custom Personal Group" },
  { key: "custom-personal-fields", label: "Custom Personal Fields" },
  { key: "annual-leave-flexibility-types", label: "Annual Leave Flexibility Types" },
]

type SettingsColumnKey = "id" | "name" | "systemGenerated" | "hidden" | "createdBy" | "createdAt" | "updatedOn" | "updatedBy" | "move"
...
const defaultSettingsColumns: SettingsColumnKey[] = ["id", "name", "systemGenerated", "hidden", "createdBy", "createdAt", "updatedOn", "updatedBy", "move"]

export function EmpSettingsTab() {
  const [activeCategory, setActiveCategory] = useState<EmpSettingCategory>("job-titles")
  ...
  const handleCategoryChange = (key: string) => {
    setActiveCategory(key as EmpSettingCategory)
    setFilters({})

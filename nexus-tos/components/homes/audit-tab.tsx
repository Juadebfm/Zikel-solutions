...
const auditCategories: { key: string; label: string }[] = [
  ...
  { key: "regulatory-report-types", label: "Regulatory Report Types" },
  { key: "regulatory-report-type-sections", label: "Regulatory Report Type Secti..." },
  { key: "regulatory-report-type-sections-2", label: "Regulatory Report Type Secti..." },
  { key: "regulatory-report-values", label: "Regulatory Report Values" },
]
...
export function AuditTab() {
  ...
  const handleCategoryChange = (key: string) => {
    setActiveCategory(key as HomeAuditCategory)
    setFilters({})

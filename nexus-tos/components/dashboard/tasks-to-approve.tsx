    ...
    <Card className="h-full">
      <CardHeader className="flex flex-row items-center justify-between pb-2 gap-2">
        <div className="flex items-center gap-2 min-w-0">
          <ClipboardCheck className="h-4 w-4 sm:h-5 sm:w-5 text-amber-600 shrink-0" />
              ...
              return (
                ...
                >
                  <Avatar className="h-8 w-8 sm:h-9 sm:w-9 shrink-0 mt-0.5 sm:mt-0">
                    <AvatarFallback className={cn("text-white text-[10px] sm:text-xs font-medium", item.submitter.color)}>

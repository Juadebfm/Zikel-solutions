# Nexus TOS — Required Backend Endpoints
...
### Phase 1 — Core Auth & Shell (must come first)
1. Auth (all 9 endpoints)
2. Current User / Me (profile, permissions)
3. Announcements (list + mark read)

### Phase 2 — Organisational Structure
4. Care Groups (CRUD + stakeholders)
5. Homes (CRUD + settings)
6. Regions & Groupings

### Phase 3 — People
7. Young People (CRUD + rewards + outcome stars + settings)
8. Employees (CRUD + permissions + settings)
9. Users (CRUD)

### Phase 4 — Clinical / Operational
10. IOI Logs (full CRUD + approval workflow)
11. Tasks (full CRUD + approval)
12. Daily Logs
13. Rotas
14. Calendar

### Phase 5 — Task Explorer & Widgets
15. Task Explorer (search)
16. My Summary stats
17. My Dashboard widgets

### Phase 6 — Files, Reports, Admin
18. Documents / File uploads
19. Vehicles
20. Reports & Exports
21. Forms & Procedures
22. Uploads (import)
